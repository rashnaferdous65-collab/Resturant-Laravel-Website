            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-3 ">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-contract"></i></div><strong>Total Food</strong>
                    </div>
             ...
             <div class="col-lg-4 col-md-3">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-paper-and-pencil"></i></div><strong>Total Category</strong>
                    </div>
                    <div class="number dashtext-3">{{$total_category}}</div>
                  </div>
                  <div class="progress progress-template">
              ...
              <div class="col-md-4 col-sm-3">
                <div class="statistic-block block">
                  <div class="progress-details d-flex align-items-end justify-content-between">
                    <div class="title">
                      <div class="icon"><i class="icon-writing-whiteboard"></i></div><strong>Total Reservation</strong>
                    </div>
                    <div class="number dashtext-4">{{$total_reservation}}</div>
                  </div>
                  <div class="progress progress-template">
